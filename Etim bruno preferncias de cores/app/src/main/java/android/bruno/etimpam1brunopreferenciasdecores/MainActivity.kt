package android.bruno.etimpam1brunopreferenciasdecores
...
import com.example.etimpam1brunopreferenciasdecores.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun salvarCor(cor: String) {
        ...
        binding.btnTrocar.setOnClickListener { view ->
            ...
            editor.putString("nome", "Bruno")
            editor.putString("sobrenome", "Romão")
